# Mirror Network Messages Service

This repository solves the problem of Mirror's NetworkMessage system that disconnects client if it does not implement a handler for a message. 
